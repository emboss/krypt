...
describe Krypt::ASN1::ObjectId do 
  ...
  describe 'accessors' do
    describe '#value' do
      subject { o = klass.new("1.2.3.4.5"); o.value = value; o }
    ...
    describe '#tag' do
      subject { o = klass.new("1.2.3.4.5"); o.tag = tag; o }
    ...
    describe '#tag_class' do
      subject { o = klass.new("1.2.3.4.5"); o.tag_class = tag_class; o }
  ...
  describe '#to_der' do
    context 'encodes a given value' do
      ...
      # TODO: When do we raise the error, on encoding or already on setting the value?
      # On setting would require to parse the value already...
